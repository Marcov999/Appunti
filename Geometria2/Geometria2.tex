...
euclidea) su $\mathbb{R}^n$, $\displaystyle d_2(x, y)=\sqrt{\sum_{i=1}^n
(x_i-y_i)^2}$;
...
\sqrt{\frac{\sum_{i=1}^n (x_i-y_i)^2}{n}}$, da cui $d_1(x, y) \le \sqrt{n} \cdot
d_2(x, y)$. Stimando tutti i termini con il massimo otteniamo che $\displaystyle
\sqrt{\sum_{i=1}^n (x_i-y_i)^2} \le \sqrt{\sum_{i=1}^n \sup_{j=1, \dots, n}
\{(x_j-y_j)^2\}}=\sqrt{n} \cdot \sup_{j=1, \dots, n} \{ |x_j-y_j| \}$, da cui
$d_2(x, y) \le \sqrt{n} \cdot d_{\infty} (x, y)$. Infine è ovvio che
$\displaystyle \sup_{i=1, \dots, n} |x_i-y_i| \le \sum_{i=1}^n |x_i-y_i|$, da
cui $d_{\infty}(x, y) \le d_1(x, y)$. Scegliendo $k=\sqrt{n}$ è ora sufficiente
applicare il lemma.
\end{proof}
