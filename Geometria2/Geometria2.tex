...
Notiamo che per il teorema 2.11 della sezione 2.2, le due definizioni di
funzione continua sono equivalenti per uno spazio metrico se si considera la
topologia indotta dalla metrica. %aggiungere riferimenti ipertestuali al teorema e alla sezione
...
%aggiungo un commento per vedere se almeno questo funziona...
