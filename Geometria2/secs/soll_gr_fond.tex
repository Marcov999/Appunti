...
\begin{thm}
  Teorema di sollevamento. Sia $p:E \longrightarrow X$ un rivestimento connesso (cioè $E$ è connesso), $x_0 \in X, \tilde{x}_0 \in p^{-1}(x_0)$ e sia $f:Y \longrightarrow X$ continua, $Y$ connesso, $y_0 \in Y$.
